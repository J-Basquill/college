...
public class BasicCircleTester
{
    public static void main(String [] args)
	{
        ...
        myCircle.setRadius(18); // use setRadius to change the radius value
       ...
       System.out.println("\n\n The value of the Circle radius is now " + number);
		...
		BasicCircle circleJames;
		circleJames = new BasicCircle(8);
		int rad = circleJames.getRadius();
		System.out.println("The value of James' circle radius is " + rad);
		circleJames.setRadius(5);
		rad = circleJames.getRadius();
		System.out.println("\nThe value of James' circle radius is now " + rad);
    }
}
