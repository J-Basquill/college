...
public class CS265B_Selenium_Week10 {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		System.out.println("CS265B_Selenium_Lab7 TESTING READY TO BEGIN");
	}
	...
	public static void tearDownAfterClass() throws Exception {
		...
		System.out.println("CS265B_Selenium_Lab7 TESTING FINISHED");
	}	
			...
			String expectedAns)
	{
		...
		System.out.println("CS265B Lab 7 TESTING: Our expected answer is [" + expectedAnswer + "]");

		// Wait for four seconds so you can physically see the output 
		// 1000 milliseconds is 1 seconds
		try {
			Thread.sleep(40);
			System.out.println("CS265B 7 FINISHED SLEEPING");
    ...
    public void takeScreenShotOnFailure(ITestResult testResult) throws IOException {
        if (testResult.getStatus() == ITestResult.FAILURE) {
            ...
            fn = "CS265B_Lab7_FailedTest_" + fn + ".png";
