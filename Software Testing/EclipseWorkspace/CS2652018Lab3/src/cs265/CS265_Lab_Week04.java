...
public class CS265_Lab_Week04 {
	...
	public static int equipmentInsurance(boolean sportsEquipment, boolean musicEquipment){
		int insurance;
	...
	public static  double saleRate(int quantity, boolean cashPayment, boolean wholesale){
